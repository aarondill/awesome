...
local function setup_environment()
  ...
  setenv("GTK_IM_MODULE", "ibus") -- Fix for browsers
  setenv("QT_IM_MODULE", "ibus") -- Not sure if this works or not, but whatever
  setenv("XMODIFIERS", "@im=ibus")
  setenv("XDG_CURRENT_DESKTOP", "GNOME:AWESOME")
  setenv("QT_QPA_PLATFORMTHEME", "gtk2")
  setenv("QT_STYLE_OVERRIDE", "gtk2")
  setenv("SHLVL", nil) -- Fix terminals opened in AwesomeWM
