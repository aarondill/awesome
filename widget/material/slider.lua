...
local function new(args)
	...
	ret._private.progress_bar = wibox.widget({
		...
		background_color = (beautiful.background or {}).hue_800,
		color = (beautiful.primary or {}).hue_500,
	...
	ret._private.slider = wibox.widget({
		...
		bar_height = 0,
		bar_color = (beautiful.primary or {}).hue_500,
		handle_color = (beautiful.primary or {}).hue_300,
